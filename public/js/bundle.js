...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/hoangle199x/ckxj03o862wvp15nxtq012a1r',
    // style URL
    scrollZoom: false // zoom: 9,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KKbUTIG98jfOrVaqyryr2VCxNb0QX02EYb9x5qy61jFYMBj58kpFOPaD5A2QBSDPXVw7pPBJ37h94WrroDsbvoM00zmIQwoV1');
            _context.prev = 1;
            _context.next = 4;
